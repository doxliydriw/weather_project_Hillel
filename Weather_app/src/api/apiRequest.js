export async function apiRequest(token, params) {
    ...
    const url = `https://api.meteomatics.com/${params.date_time.value}T10:55:00.000+02:00/${parameters_url.replace(/,$/, "")}/${params.latitude.value},${params.longitude.value}/json??access_token=${token.data}`
    // console.log(url)
